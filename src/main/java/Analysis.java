...
public class Analysis {
    ...
    public List<String> getFehler() {
        ...
        for (Instance d : data_temp) {
            ...
            if (d.toString(6).equals(null)) {
               ...
               * result[6] = "Error:Das Feld in Spalte (Einkaufszeit) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(8).equals(null)) {
                myList.add(
                        "Error:Das Feld in Spalte (Haushaltsnettoeinkommen) und Zeile (" + row_nummer + "): iat leer");
            } /*
               * else {
               * temp = d.toString(8);
               ...
               * if (!(intValue > 0) && !(intValue < 2525)) {
               * result[8] = "Error:Das Feld in Spalte (Haushaltsnettoeinkommen) und Zeile ("
               * + row_nummer
               * + "):"
               * + temp + ".";
               * }
            ...
            if (d.toString(9).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[9] = "Error:Das Feld in Spalte (Einkaufssumme) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(10).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[10] = "Error:Das Feld in Spalte (Fertiggerichte) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(11).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[11] = "Error:Das Feld in Spalte (Tiefkuehlware) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(12).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[12] = "Error:Das Feld in Spalte (Milchprodukte) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(14).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[14] = "Error:Das Feld in Spalte (Obst/Gemüse) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(15).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[15] = "Error:Das Feld in Spalte (Spirituosen) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(16).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[16] = "Error:Das Feld in Spalte (Tiernahrung) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(18).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[18] = "Error:Das Feld in Spalte (Frischfleisch) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(19).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[19] = "Error:Das Feld in Spalte (Drogerieartikel) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(22).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[22] = "Error:Das Feld in Spalte (Suessigkeiten) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
            ...
            if (d.toString(24).equals(null)) {
               ...
               * if (!(intValue >= 0)) {
               * result[24] = "Error:Das Feld in Spalte (Schreibwaren) und Zeile (" +
               * row_nummer + "):"
               * + temp + ".";
               * }
               * } catch (NumberFormatException e) {
    ...
    // Methode, um den Umsatzst�rkster Einkaufstag zu ermitteln
    ...
    public Map<String, Double> UmsatzstarksterEinkaufstag() {
        ...
        // Alle Datens�tze durchlaufen und jedes mal summieren
    ...
    // Methode, um den Umsatzst�rkster Einkaufszeit zu ermitteln
    ...
    // Methode, um die Umsatzst�rkste Einkaufsuhrzeit an einzelnen Tagen zu
    // ermitteln
    ...
    public Map<String, String> StarksteZeitAmTag() {
        ...
        // Durchlaufen aller Instanzen und Aufsummieren der st�ndlichen Ums�tze
        for (int i = 0; i < data.numInstances(); i++) {
            ...
            // aktuelle Summe mit der vohrer gespeicherten s vergleichen und die hashmaps
            // aktualiseren
    ...
    // Methode, die um st�rkste Einkaufstag nach kundenhaufigkeit
    public Map<String, Integer> StaerksteTagNachHaufigkeit() {

        Map<String, Integer> map = new HashMap<>();
        int tagIndex = data.attribute("Einkaufstag").index();

        // Alle Datens�tze durchlaufen und jedes mal inkrementieren
        for (int i = 0; i < data.numInstances(); i++) {
    ...
    // Methode, die um st�rkste Einkaufszeit nach kundenhaufigkeit
