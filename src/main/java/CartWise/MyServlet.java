...
public class MyServlet extends HttpServlet {
	...
	private String[] testRowValues(String[] row, int row_num) {
		...
		if (!"Freitag".equals(row[5]) && !"Samstag".equals(row[5]) && !"Dienstag".equals(row[5])
				&& !"Montag".equals(row[5]) && !"Mittwoch".equals(row[5]) && !"Sonntag".equals(row[5])
				&& !"Donnerstag".equals(row[5]) || row[5] == null) {
